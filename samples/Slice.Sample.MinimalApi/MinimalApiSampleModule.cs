...
namespace Slice.Sample.MinimalApi;

/// <summary>
/// Root module for the minimal-API sample. Self-registers handlers, validators, link contributors,
/// permission providers, the DbContext and repository. Endpoints live in feature folders as
/// <c>ISliceEndpoint</c>s and are discovered by <c>MapSliceEndpoints</c> in Program.cs.
/// </summary>
[DependsOn(
...
public sealed class MinimalApiSampleModule : SliceModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        var services = context.Services;
        var assembly = typeof(MinimalApiSampleModule).Assembly;
