...
namespace Slice.Sample.Monolith.Contracts;
...
[DistributedEventName("sales.order-placed")]
...
[DistributedEventName("inventory.stock-reserved")]
public sealed record StockReservedEto(Guid OrderId, string Sku, int Quantity) : IDistributedEvent;
